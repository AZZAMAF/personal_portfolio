...
export const Testimonials = ()=> {
    ...
    const next = () => setCurSlide((prev) => (prev + 1)
    % testimonials.length)
        ...
        >
            ...
            <div className="mt-10 relative w-full">
                <AnimatePresence mode="wait">
                    ...
                    layout
                    className="border rounded-3xl border-neutral-800 bg-neutral-900/10 p-8
                    ...
                    >
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            <a href={testimonials[curSlide].link}
                            className="inline-flex items-center gap-1 text-sm font-medium
                            hover:text-green-400 text-neutral-400 transition">
                                Project -
                            </a>
                        </div>
                    </motion.div>
                ...
                <div className="flex gap-4 mt-8">
                    <button onClick={prev} className="size-10 flex items-center justify-center rounded-full 
                    border border-neutral-700 hover:bg-neutral-800 transition">
                        <ChevronLeftIcon size={18} />
                    </button>
                    
                    <button onClick={next} className="size-10 flex items-center justify-center rounded-full 
                    border border-neutral-700 hover:bg-neutral-800 transition">
