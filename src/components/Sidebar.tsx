    ...
    return (
        <>
            ...
            py-6 pl-10" >
                    ...
                    >Menu</SheetTitle>
                    <nav className="flext flex-col gap-4">
                        {navLinks.map((link) => {
                            ...
                            return (
                                <a
                                    ...
                                    // 2. Pastikan kurung cn() ditutup dengan benar
                                    className={cn(
                                ...
                                >
                                    {/* 3. Gunakan Icon yang sudah didefinisikan */}
                        ...
                        <div className="flex gap-3 text-neutral-500">
                            {socialLinks.map((social, i)=>{
                                ...
                                return (
                                    ...
                                    border-2 border-neutral-500 p-2 rounded-full hover:border-primary
